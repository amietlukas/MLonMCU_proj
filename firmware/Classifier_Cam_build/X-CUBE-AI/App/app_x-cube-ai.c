...
/* This project doesn't run an AI model — dataset_gather_app drives the
 * camera + WiFi pipeline directly from main(). MX_X_CUBE_AI_Init/Process
 * stay as no-ops below. */
...
AI_ALIGNED(32)
static uint8_t pool0[AI_BIG_NET_PRUNED_INT8_DATA_ACTIVATION_1_SIZE];
...
static const ai_network_entry_t networks[AI_MNETWORK_NUMBER] = {
    {
        .name = (const char *)AI_BIG_NET_PRUNED_INT8_MODEL_NAME,
        .config = AI_BIG_NET_PRUNED_INT8_DATA_CONFIG,
        .ai_get_report = ai_big_net_pruned_int8_get_report,
        .ai_create = ai_big_net_pruned_int8_create,
        .ai_destroy = ai_big_net_pruned_int8_destroy,
        .ai_get_error = ai_big_net_pruned_int8_get_error,
        .ai_init = ai_big_net_pruned_int8_init,
        .ai_run = ai_big_net_pruned_int8_run,
        .ai_forward = ai_big_net_pruned_int8_forward,
        .ai_data_params_get = ai_big_net_pruned_int8_data_params_get,
