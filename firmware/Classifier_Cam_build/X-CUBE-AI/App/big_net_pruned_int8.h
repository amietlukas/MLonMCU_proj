/**
  ...
  ******************************************************************************
  */
#ifndef AI_BIG_NET_PRUNED_INT8_H
#define AI_BIG_NET_PRUNED_INT8_H

#include "big_net_pruned_int8_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_BIG_NET_PRUNED_INT8_MODEL_NAME          "big_net_pruned_int8"
#define AI_BIG_NET_PRUNED_INT8_ORIGIN_MODEL_NAME   "bignet_pruned20260505225640_bestepoch132_int8_qdq_op13"

/******************************************************************************/
#define AI_BIG_NET_PRUNED_INT8_ACTIVATIONS_ALIGNMENT   (4)
#define AI_BIG_NET_PRUNED_INT8_INPUTS_IN_ACTIVATIONS   (4)
#define AI_BIG_NET_PRUNED_INT8_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_BIG_NET_PRUNED_INT8_IN_NUM        (1)

AI_DEPRECATED
#define AI_BIG_NET_PRUNED_INT8_IN \
  ai_big_net_pruned_int8_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_BIG_NET_PRUNED_INT8_IN_SIZE { \
  AI_BIG_NET_PRUNED_INT8_IN_1_SIZE, \
}
#define AI_BIG_NET_PRUNED_INT8_IN_SIZE_BYTES { \
  AI_BIG_NET_PRUNED_INT8_IN_1_SIZE_BYTES, \
}
#define AI_BIG_NET_PRUNED_INT8_IN_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_BIG_NET_PRUNED_INT8_IN_1_HEIGHT      (120)
#define AI_BIG_NET_PRUNED_INT8_IN_1_WIDTH       (160)
#define AI_BIG_NET_PRUNED_INT8_IN_1_CHANNEL     (1)
#define AI_BIG_NET_PRUNED_INT8_IN_1_SIZE        (19200)
#define AI_BIG_NET_PRUNED_INT8_IN_1_SIZE_BYTES  (19200)

/******************************************************************************/
#define AI_BIG_NET_PRUNED_INT8_OUT_NUM       (1)

AI_DEPRECATED
#define AI_BIG_NET_PRUNED_INT8_OUT \
  ai_big_net_pruned_int8_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_BIG_NET_PRUNED_INT8_OUT_SIZE { \
  AI_BIG_NET_PRUNED_INT8_OUT_1_SIZE, \
}
#define AI_BIG_NET_PRUNED_INT8_OUT_SIZE_BYTES { \
  AI_BIG_NET_PRUNED_INT8_OUT_1_SIZE_BYTES, \
}
#define AI_BIG_NET_PRUNED_INT8_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_BIG_NET_PRUNED_INT8_OUT_1_CHANNEL     (6)
#define AI_BIG_NET_PRUNED_INT8_OUT_1_SIZE        (6)
#define AI_BIG_NET_PRUNED_INT8_OUT_1_SIZE_BYTES  (6)

/******************************************************************************/
#define AI_BIG_NET_PRUNED_INT8_N_NODES (13)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup big_net_pruned_int8
 ...
 * @ref ai_big_net_pruned_int8_create. Both the activations memory buffer 
 ...
 * using @ref ai_big_net_pruned_int8_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_big_net_pruned_int8_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_big_net_pruned_int8_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_BIG_NET_PRUNED_INT8_*
 * defines into file @ref big_net_pruned_int8.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_big_net_pruned_int8_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_BIG_NET_PRUNED_INT8_H */
