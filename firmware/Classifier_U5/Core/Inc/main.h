...
/* mx_wifi_spi.c references MXCHIP_SPI as the SPI HAL handle. Bind it to
 * the hspi2 handle generated by CubeMX when SPI2 is enabled. Lives in
 * USER CODE so future regens preserve it. */
#include "spi.h"
