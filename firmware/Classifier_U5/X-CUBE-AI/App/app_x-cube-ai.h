...
#define AI_BIG_NET_PRUNED_INT8_DATA_ACTIVATIONS_START_ADDR 0xFFFFFFFF

#define AI_MNETWORK_DATA_ACTIVATIONS_INT_SIZE AI_BIG_NET_PRUNED_INT8_DATA_ACTIVATIONS_SIZE
