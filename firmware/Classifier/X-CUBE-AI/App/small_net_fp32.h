/**
  ...
  ******************************************************************************
  */
#ifndef AI_SMALL_NET_FP32_H
#define AI_SMALL_NET_FP32_H

#include "small_net_fp32_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SMALL_NET_FP32_MODEL_NAME          "small_net_fp32"
#define AI_SMALL_NET_FP32_ORIGIN_MODEL_NAME   "bignet20260505163101_bestepoch128_fp32_op13"

/******************************************************************************/
#define AI_SMALL_NET_FP32_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SMALL_NET_FP32_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SMALL_NET_FP32_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SMALL_NET_FP32_IN_NUM        (1)

AI_DEPRECATED
#define AI_SMALL_NET_FP32_IN \
  ai_small_net_fp32_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_NET_FP32_IN_SIZE { \
  AI_SMALL_NET_FP32_IN_1_SIZE, \
}
#define AI_SMALL_NET_FP32_IN_SIZE_BYTES { \
...
#define AI_SMALL_NET_FP32_IN_1_WIDTH       (160)
#define AI_SMALL_NET_FP32_IN_1_CHANNEL     (1)
#define AI_SMALL_NET_FP32_IN_1_SIZE        (19200)
#define AI_SMALL_NET_FP32_IN_1_SIZE_BYTES  (76800)

/******************************************************************************/
#define AI_SMALL_NET_FP32_OUT_NUM       (1)

AI_DEPRECATED
#define AI_SMALL_NET_FP32_OUT \
  ai_small_net_fp32_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_NET_FP32_OUT_SIZE { \
  AI_SMALL_NET_FP32_OUT_1_SIZE, \
}
#define AI_SMALL_NET_FP32_OUT_SIZE_BYTES { \
  AI_SMALL_NET_FP32_OUT_1_SIZE_BYTES, \
}
#define AI_SMALL_NET_FP32_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_SMALL_NET_FP32_OUT_1_CHANNEL     (6)
#define AI_SMALL_NET_FP32_OUT_1_SIZE        (6)
 ...
 * @ref ai_small_net_fp32_create. Both the activations memory buffer 
 ...
 * using @ref ai_small_net_fp32_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_net_fp32_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_net_fp32_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SMALL_NET_FP32_*
 * defines into file @ref small_net_fp32.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_small_net_fp32_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SMALL_NET_FP32_H */
