...
#define AI_SMALL_NET_FP32_MODEL_SIGNATURE     "0xe9f88ccb2ba090e766e35e8df40b2cab"
...
#define AI_TOOLS_DATE_TIME   "2026-05-18T15:00:29+0200"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  1, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 40, 30), AI_STRIDE_INIT(4, 4, 4, 256, 10240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  3, 0x0,
  AI_SHAPE_INIT(4, 1, 64, 80, 2), AI_STRIDE_INIT(4, 4, 4, 256, 20480),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 128, 40, 2), AI_STRIDE_INIT(4, 4, 4, 512, 20480),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 80, 60), AI_STRIDE_INIT(4, 4, 4, 128, 10240),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  13, 0x0,
  AI_SHAPE_INIT(4, 1, 32, 160, 2), AI_STRIDE_INIT(4, 4, 4, 128, 20480),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 373784, 1, 1),
    373784, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 707108, 1, 1),
    707108, NULL, NULL),
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_small_net_fp32_activations_map, 1, params)) {
    ...
    input_output_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 589312);
    input_output_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 589312);
    getitem_scratch0_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 666112);
    getitem_scratch0_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 666112);
    getitem_scratch1_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 666148);
    getitem_scratch1_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 666148);
    getitem_output_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 21248);
    getitem_output_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 21248);
    getitem_3_scratch0_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 635648);
    getitem_3_scratch0_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 635648);
    getitem_3_scratch1_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 636800);
    getitem_3_scratch1_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 636800);
    ...
    getitem_6_scratch0_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 307200);
    getitem_6_scratch0_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 307200);
    getitem_6_scratch1_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 309504);
    getitem_6_scratch1_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 309504);
    getitem_6_output_array.data = AI_PTR(g_small_net_fp32_activations_map[0] + 350464);
    getitem_6_output_array.data_start = AI_PTR(g_small_net_fp32_activations_map[0] + 350464);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_small_net_fp32_weights_map, 1, params)) {
    ...
    getitem_bias_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 1152);
    getitem_bias_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 1152);
    getitem_3_weights_array.format |= AI_FMT_FLAG_CONST;
    getitem_3_weights_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 1280);
    getitem_3_weights_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 1280);
    getitem_3_bias_array.format |= AI_FMT_FLAG_CONST;
    getitem_3_bias_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 75008);
    getitem_3_bias_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 75008);
    getitem_6_weights_array.format |= AI_FMT_FLAG_CONST;
    getitem_6_weights_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 75264);
    getitem_6_weights_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 75264);
    getitem_6_bias_array.format |= AI_FMT_FLAG_CONST;
    getitem_6_bias_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 370176);
    getitem_6_bias_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 370176);
    logits_weights_array.format |= AI_FMT_FLAG_CONST;
    logits_weights_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 370688);
    logits_weights_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 370688);
    logits_bias_array.format |= AI_FMT_FLAG_CONST;
    logits_bias_array.data = AI_PTR(g_small_net_fp32_weights_map[0] + 373760);
    logits_bias_array.data_start = AI_PTR(g_small_net_fp32_weights_map[0] + 373760);
    return true;
  }
