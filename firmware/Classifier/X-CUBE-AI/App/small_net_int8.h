/**
  ...
  ******************************************************************************
  */
#ifndef AI_SMALL_NET_INT8_H
#define AI_SMALL_NET_INT8_H

#include "small_net_int8_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_SMALL_NET_INT8_MODEL_NAME          "small_net_int8"
#define AI_SMALL_NET_INT8_ORIGIN_MODEL_NAME   "bignet20260505163101_bestepoch128_int8_qdq_op13"

/******************************************************************************/
#define AI_SMALL_NET_INT8_ACTIVATIONS_ALIGNMENT   (4)
#define AI_SMALL_NET_INT8_INPUTS_IN_ACTIVATIONS   (4)
#define AI_SMALL_NET_INT8_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_SMALL_NET_INT8_IN_NUM        (1)

AI_DEPRECATED
#define AI_SMALL_NET_INT8_IN \
  ai_small_net_int8_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_NET_INT8_IN_SIZE { \
  AI_SMALL_NET_INT8_IN_1_SIZE, \
}
#define AI_SMALL_NET_INT8_IN_SIZE_BYTES { \
...
AI_DEPRECATED
#define AI_SMALL_NET_INT8_OUT \
  ai_small_net_int8_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_SMALL_NET_INT8_OUT_SIZE { \
  AI_SMALL_NET_INT8_OUT_1_SIZE, \
}
#define AI_SMALL_NET_INT8_OUT_SIZE_BYTES { \
  AI_SMALL_NET_INT8_OUT_1_SIZE_BYTES, \
}
#define AI_SMALL_NET_INT8_OUT_1_FORMAT      (AI_BUFFER_FORMAT_S8)
#define AI_SMALL_NET_INT8_OUT_1_CHANNEL     (6)
#define AI_SMALL_NET_INT8_OUT_1_SIZE        (6)
#define AI_SMALL_NET_INT8_OUT_1_SIZE_BYTES  (6)

/******************************************************************************/
#define AI_SMALL_NET_INT8_N_NODES (14)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup small_net_int8
 ...
 * @ref ai_small_net_int8_create. Both the activations memory buffer 
 ...
 * using @ref ai_small_net_int8_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_net_int8_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_small_net_int8_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_SMALL_NET_INT8_*
 * defines into file @ref small_net_int8.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_small_net_int8_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_SMALL_NET_INT8_H */
